	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == vista.botonAgregarAnimal) {
			...
			String[] animalesTerrestres = { "León", "Tigre", "Jirafa", "Elefante", "Rinoceronte", "Cocodrilo",
					...
					"Canguro", "Camello", "Mono", "Orangután", "Gorila", "Chimpancé", "Cebra", "Antílope", "Búfalo",
					"Alce", "Ciervo", "Avestruz" };

			// Animales marinos
			String[] animalesMarinos = { "Delfin", "Foca", "Orca", "Ballena", "Pulpo" };

			// Animales aéreos
			String[] animalesAereos = { "Flamenco", "Cisne", "Loro", "Búho", "Guacamaya", "Pato", "Pavo real" };
