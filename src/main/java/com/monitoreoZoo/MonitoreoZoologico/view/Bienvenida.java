...
public class Bienvenida extends JFrame implements ActionListener {
	...
	public Bienvenida() {
		...
		ImageIcon imagen = new ImageIcon(new ImageIcon(getClass().getClassLoader().getResource("images/bienvenido.png"))
				.getImage().getScaledInstance(700, 300, Image.SCALE_DEFAULT));
